...
public class AccountRepository
{
    ...
    public async Task<List<Account>> GetAllAsync()
    {
        ...
        try
        {
            await using var stream =
                new FileStream(_filePath, FileMode.Open, FileAccess.Read, FileShare.Read, 4096, true);
    ...
    public async Task SaveAllAsync(List<Account> accounts)
    {
        try
        {
            ...
            await using var stream =
                new FileStream(_filePath, FileMode.Create, FileAccess.Write, FileShare.None, 4096, true);
            await JsonSerializer.SerializeAsync(stream, validAccounts,
